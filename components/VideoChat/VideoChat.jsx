...
function VideoChat({ handleEndCall }) {
  ...
  const { sendMessage, lastMessage, readyState } = useWebSocket('ws://185.251.88.75:8000/ws/room/5/');
  ...
  useEffect(() => {
    ...
    const connectToRoom = async () => {
      try {
        ...
        const bearerToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzA1NTU4NDkzLCJpYXQiOjE3MDAzNzQ0OTMsImp0aSI6ImI5ZWExN2ZhMzM2YzQzNGE4OGI5ODQ1ZDk5ZDVlZTI0IiwidXNlcl9pZCI6NX0.gpbox6CSMjC1Yr4-NCdK4nUYcI10aM4vOnJ7EwnaT9k';
    ...
    <div className={s.VideoChat}>
      ...
      <div className={s.roomVideoChats}>
        <div className={s.roomVideoChat} >
          ...
          {cameraIndexFo === 2 ? (
            room && <Participant participant={room.localParticipant} height={200} />
          ) : (
            participants.length > 0 && (
              <div > 
              <Participant 
